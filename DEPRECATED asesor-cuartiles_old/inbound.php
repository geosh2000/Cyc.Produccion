...
if($dep==3){$dep=" IN (3,35)";}else{$dep="=$dep";}
	...
	LEFT JOIN
		(
			...
			FROM
				(
					SELECT
						asesor, Fechas.Fecha, Localizador, Afiliado, SUM(VentaMXN+OtrosIngresosMXN+EgresosMXN)*1 as Monto
					FROM
						Fechas
					LEFT JOIN
						t_Locs
	...
	LEFT JOIN
		(
			...
			FROM
				(
					SELECT
						asesor, Fechas.Fecha, Localizador, SUM(VentaMXN+OtrosIngresosMXN+EgresosMXN)*1 as Monto, SUM(IF(Afiliado LIKE '%pricetravel.com%',Venta+OtrosIngresos+Egresos,0))*Dolar as MontoMP
					FROM
						Fechas
					LEFT JOIN
						t_Locs
        ...
        $('#info, #info_aht').tablesorter({
            ...
            widgetOptions: {
               ...
               uitheme: 'jui',
                ...
                output_saveFileName  : 'cuartiles_<?php echo "$year"."_$month"."_$dep";?>.xls',

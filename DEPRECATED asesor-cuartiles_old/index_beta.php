...
$q_2=intval(count($sort['AHT'])/4)*2+1;
$q_3=intval(count($sort['AHT'])/4)*3+2;

?>

<br><br>
<table id='info' width='100%' class='t2'>
    <thead>
    <tr class='title'>
    <?php
         $csv_hdr="Info,";
        ...
        foreach($data_asesores as $key => $info){
            ...
            foreach($field as $key2=> $parameter){
                ...
                switch($parameter){
                    ...
                    case 'Monto':
                        if($class!="class='not'"){
                            if($info[$parameter]>=$sort[$parameter][$q_3]){$p_class="<img src='/images/orangeflag.png' alt='Q3' height='20' width='20'>"; $q=3;}else{$p_class="<img src='/images/redflag.png' alt='Q3' height='20' width='20'>"; $q=4;}
                            if($info[$parameter]>=$sort[$parameter][$q_2]){$p_class="<img src='/images/yellowflag.png' alt='Q3' height='20' width='20'>"; $q=2;}
                            if($info[$parameter]>=$sort[$parameter][$q_1]){$p_class="<img src='/images/greenflag.png' alt='Q3' height='20' width='20'>"; $q=1;}
                        }else{$p_class="";}
                        break;
                    case 'Colgadas_porcentaje':
                    case 'AHT':
                    ...
                    case 'Faltas':
                        if($class!="class='not'"){
                            if($info[$parameter]>$sort[$parameter][$q_1]){$p_class="<img src='/images/yellowflag.png' alt='Q3' height='20' width='20'>"; $q=2;}else{$p_class="<img src='/images/greenflag.png' alt='Q3' height='20' width='20'>"; $q=1;}
                            if($info[$parameter]>$sort[$parameter][$q_2]){$p_class="<img src='/images/orangeflag.png' alt='Q3' height='20' width='20'>"; $q=3;}
                            if($info[$parameter]>$sort[$parameter][$q_3]){$p_class="<img src='/images/redflag.png' alt='Q3' height='20' width='20'>"; $q=4;}
                        }else{$p_class="";}
                        break;
                    case 'Nombre':
                    if($class=="class='not'"){
                        $p_class="<img src='/images/not.png' alt='No Cuartilizable' height='20' width='20'>";
                    }else{$p_class="";}
                    break;
                    default:
                        $p_class="";

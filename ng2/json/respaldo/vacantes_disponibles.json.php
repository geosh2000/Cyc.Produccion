...
validateTk(function(){
    ...
    //            'id' => $fila['puestoid'],
        ...
        break;
      case "ciudad":
        $query="SELECT a.ciudad as ciudadid, e.Ciudad FROM asesores_plazas a LEFT JOIN asesores_movimiento_vacantes b ON a.id=b.vacante LEFT JOIN db_municipios e ON a.ciudad=e.id LEFT JOIN hc_codigos_Departamento deps ON a.hc_dep=deps.id LEFT JOIN hc_codigos_Areas areas ON deps.area=areas.id LEFT JOIN hc_codigos_UnidadDeNegocio udns ON areas.unidadDeNegocio=udns.id

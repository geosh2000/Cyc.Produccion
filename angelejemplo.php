...
function ldap_auth() {
    $ldap_server = 'ccad02.pricetravel.com.mx';
    $ldap_domain = 'dc=pricetravel,dc=com,dc=mx';
    $ldap_userbase = 'ou=DevOps-Sysadmin,ou=DevOps,ou=IT-Mexico,ou=Tecnologías de Información,ou=Corporativo Cancún,ou=PriceTravel Mexico,ou=Precio y Viajes,' . $ldap_domain;

...
$query="SELECT nivel, titulo FROM OBMT_opts GROUP BY nivel";
...
$query="SELECT a.id, CAST(date_created as TIME) as Hora,
			...
			LEFT JOIN OBMT_opts h ON a.level7=e.id
			LEFT JOIN OBMT_opts i ON a.level8=f.id
			LEFT JOIN OBMT_opts j ON a.level9=g.id
			WHERE

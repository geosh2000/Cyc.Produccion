    ...
    public function avancePdvMes_get(){
        ...
        $result = validateToken( $_GET['token'], $_GET['usn'], $func = function(){
            ...
            SELECT 
                ...
                PdvId,
                meta_total_diaria / 
                        IF(metasAsesores<vacsCovrd,metasAsesores, -- Linea para comentar o eliminar después del 1 de abril de 2019
                        metasAsesores + IF(COUNT(IF(COALESCE(js, 0) != COALESCE(je, 0)
                            AND COALESCE(programable, 0) != 1,
                        ppr.asesor,
                        NULL)) < metasAsesores, meta_total_diaria / metasAsesores * .5,0)
                ...
                meta_hotel_diaria / 
                        ...
                        metasAsesores + IF(COUNT(IF(COALESCE(js, 0) != COALESCE(je, 0)
                            AND COALESCE(programable, 0) != 1,
                        ppr.asesor,
                        NULL)) < metasAsesores, meta_hotel_diaria / metasAsesores * .5,0)
                        ) -- Linea para comentar o eliminar después del 1 de abril de 2019
            ...
            FROM
				...
				pdvVacantes pv ON ofOK = pv.oficina -- Linea para comentar o eliminar después del 1 de abril de 2019

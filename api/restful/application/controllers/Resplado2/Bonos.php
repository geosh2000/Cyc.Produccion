        ...
        $result = validateToken( $_GET['token'], $_GET['usn'], $func = function(){
            ...
            $rev = $this->db->query("SELECT 
                    IF('".$data['lu']."' = Last_Update,
                        1,
                        IF('2018-04-04 17:35:34' BETWEEN ADDTIME(Last_Update, - '00:01:00') AND ADDTIME(Last_Update, '00:01:00')
...
//            okResponse('Aprobación Actualizada', 'data', $rev->row_array(), $this, 'params', $data['params'] );

...
$a = array();
	...
	if ($HLLc[$td][$i]==0){$today=NULL;}else{$today=$HLLc[$td][$i];}
          $rows[] = array("c"=>array(array("v"=>$CVHora[$i-1],"f"=>null),array("v"=>$today,"f"=>null),array("v"=>$HLLc[$yd][$i],"f"=>null),array("v"=>$HLLc[$lwd][$i],"f"=>null),array("v"=>$forecast,"f"=>null),array("v"=>$prn,"f"=>null),array("v"=>1.15,"f"=>null),array("v"=>0.85,"f"=>null)));
          $i++;
       }

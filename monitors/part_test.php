    ...
    $.ajax({
      ...
      success: function(array){
        ...
        if(data['status']==1){
          ...
          flagGet=data['special']['lu'];

          partChart.setTitle({ text: 'Participación de Llamadas <?php echo $title; ?><br>Total Llamadas: ' + data['Total'] + '<br>' + data['special']['lu']});

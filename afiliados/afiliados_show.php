...
if($_SESSION['default']==0){
  $query="SELECT * FROM afiliados_view WHERE users LIKE '%".$_SESSION['id']."%' AND afiliado='".$_GET['reporte']."' ORDER BY afiliado";
              ...
              widgetOptions: {
                //Filters
                  ...
                  filter_childRows: false,
                      ...
                      output_saveFileName  : 'reporte<?php echo $_GET['reporte']; ?>_'+$('#inicio').val()+'-'+$('#fin').val()+'-VECI.csv',

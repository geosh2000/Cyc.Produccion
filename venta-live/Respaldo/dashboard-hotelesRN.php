...
$query="SELECT * FROM config_dashboard WHERE tag='hotel'";
...
<div><p style='color: white; font-size:35px; font-weight: bold; text-align: center'>Conteo de RN MX</p></div>

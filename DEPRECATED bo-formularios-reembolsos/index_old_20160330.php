...
$(function() {
    ...
    function submitForm(){
        ...
        if(submit_loc=='required' || field_loc.val()!=""){
            field_val= field_val && checkLength( field_loc, "Localizador", 9, 10 );
...
if(isset($_POST['actividad'])){
    $query="INSERT INTO bo_reembolsos
    (actividad, tipo_seguimiento, em, localizador, fecha_recepcion, hora_recepcion,user)
    VALUES
    ($sel_actividad,$sel_seguimiento,$sel_caso,$sel_loc,$sel_fecha,$sel_hora,'$sel_user')";
    mysql_query($query);
    if(mysql_errno()){
...
<form method='POST' action='<?php echo $_SERVER['PHP_SELF']; ?>' name="reembolsos" id="reembolsos">
<tr class='title'>
...
<tr class='title' id='tabAct1'>
    ...
    <tr class='title' id='tabAsig1'>
        <th>Fecha Solicitud/Recepcion</th>
    ...
    <tr class='title' id='tabAsig2'>
        <th>Hora Solicitud/Recepcion (24 hrs.)</th>

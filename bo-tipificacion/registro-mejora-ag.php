...
initSettings::printTitle('SAC BO - Tipificación Mejora Continua');
...
<div class='formulario'>
    <div class='titulo'>
        <p style='padding-top: 13px; color: white;'>BackOffice - Mejora Continua (Agencias)</p>
    ...
    <div id='contain-tipo' class='campo'>
        ...
        <div class='opcion'>
            ...
            <?php
                $query="SELECT * FROM bo_status WHERE area=$OK_area ORDER BY status";

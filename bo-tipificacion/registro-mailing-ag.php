...
initSettings::printTitle('SAC BO - Tipificación Mailing');
...
$(function(){
    ...
    $('#submit_form').click(function(){
        ...
        if(flag){
            ...
            var casos=casosok;
        	var variables="asesor=<?php echo $asesor; ?>&area=<?php echo $area; ?>&caso=" + casos + "&localizador=" + $('#f_localizador').val() + "&datec=" +  $('#date-in').val() + "&tipo=" +  $('#f_tipo').val();
            //alert(variables);
...
<div class='formulario'>
    <div class='titulo'>
        <p style='padding-top: 13px; color: white;'>BackOffice - Mailing (Agencias) </p>

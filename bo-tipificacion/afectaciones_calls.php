...
$init_title='Afectaciones - Llamadas';   //Titulo Formulario
$init_table='formulario_BO_Afectaciones_calls'; //Tabla de opciones
$init_query='query_afectaciones.php';     //Archivo para subir resultados
$init_saveTo='bo_afectaciones_llamadas';     //Tabla para guardar resultados

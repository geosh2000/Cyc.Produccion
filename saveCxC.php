...
if(!isset($_SESSION['asesor_id'])){
  ...
  $query="INSERT asesores_cxc (asesor,localizador,monto,fecha_cxc,fecha_aplicacion,firmado,comments,created_by) VALUES (".$data['asesor'].",".$data['loc'].",".$data['monto'].",".$data['fecha_cxc'].",".$data['fecha_ap'].",$firmado,".$data['comments'].",$user)";

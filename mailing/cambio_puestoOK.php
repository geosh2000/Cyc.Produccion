...
function sendMail($user, $m_data){
                                                                       ...
                                                                       <tbody>
                                                                          <tr>
                                                                             <td valign='top' style='padding-top: 9px;padding-right: 18px;padding-bottom: 9px;padding-left: 18px;mso-table-lspace: 0pt;mso-table-rspace: 0pt;-ms-text-size-adjust: 100%;-webkit-text-size-adjust: 100%;color: #606060;font-family: Helvetica;font-size: 15px;text-align: center;'>
                                                                                ...
                                                                                <p style='line-height: 140%;'> El usuario <em><span style='color: #5266a2;'><strong>".$m_data['sol']."</strong></span>&nbsp;</em>ha $status_b la siguiente solicitud de cambio:<br><br><span style='text-decoration: underline; color: #5266a2;'><strong>".$m_data['asesor']."<br></strong></span><br><span style='text-decoration: underline; color: #5266a2;'><strong>".utf8_encode($m_data['new_dep'])." -&gt;&nbsp;".utf8_encode($m_data['new_puesto'])."</strong>
                                                                                <br>(".$m_data['new_ofi'].")<br></span>con fecha: <span style='text-decoration: underline; color: #5266a2;'><strong>".$m_data['fecha_cambio']."</strong></span></p>";
  ...
  mail("$user@pricetravel.com","Cambio de Status para Cambio de Puesto (".$m_data['usuario'].")",$msg,$headers);
...
$query="SELECT usuario FROM mail_lists WHERE notif='cambio_puestoOK'";
if($result=Queries::query($query)){

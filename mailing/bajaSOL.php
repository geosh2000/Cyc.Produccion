...
function sendMail($user, $m_data){
                                                                       ...
                                                                       <tbody>
                                                                          <tr>
                                                                             <td valign='top' style='padding-top: 9px;padding-right: 18px;padding-bottom: 9px;padding-left: 18px;mso-table-lspace: 0pt;mso-table-rspace: 0pt;-ms-text-size-adjust: 100%;-webkit-text-size-adjust: 100%;color: #606060;font-family: Helvetica;font-size: 15px;text-align: center;'>
                                                                                <p><span style='color: #5266a2; font-size: 24px; line-height: 130%;'>¡Hola $name!<br><br>Tienes una solicitud de aprobación para la Baja de un colaborador</span></p>
                                                                                <p style='line-height: 140%;'> El usuario <em><span style='color: #5266a2;'><strong>".$m_data['sol']."</strong></span>&nbsp;</em>ha solicitado la siguiente baja:<br><br><span style='text-decoration: underline; color: #5266a2;'><strong>".$m_data['usuario']."<br></strong></span><br>Puesto Actual: <span style='text-decoration: underline; color: #5266a2;'><strong>".utf8_encode($m_data['old_dep'])." -&gt;&nbsp;".utf8_encode($m_data['old_puesto'])."</strong><br>(".$m_data['old_ofi'].")<br><br></span><br></span>con fecha: <span style='text-decoration: underline; color: #5266a2;'><strong>".$m_data['fecha_cambio']."</strong></span></p>";
                                                                                
                                                                                if($m_data['replace']==1){
                                                                                  $msg.="<p style='line-height: 140%;'>La vacante anterior quedaría liberada con fecha <strong>".$m_data['fecha']."</strong></p>";
                                                                                }else{
                                                                                  $msg.="<p style='line-height: 140%;'>La vacante anterior ha quedaría inactiva por lo que no necesita reemplazo</strong></p>";
                                                                                }
                                                                                
                                                                                $msg.="<p>Para revisar la solicitud, haz click <a href='https://operaciones.pricetravel.com.mx/detalle-asesores/solicitudesRRHH.php'>aquí</a></p><p style='line-height: 140%;'>¡Saludos! </p>
  ...
  mail("$user@pricetravel.com","Solicitud de Baja (".$m_data['usuario'].")",$msg,$headers);
...
$query="SELECT NombreAsesor(".$_SESSION['asesor_id'].",1) as sol, NombreAsesor($asesor,1) as asesor, b.Departamento, c.Puesto, PDV FROM asesores_plazas a LEFT JOIN PCRCs b ON a.departamento=b.id LEFT JOIN PCRCs_puestos c ON a.puesto=c.id LEFT JOIN PDVs e ON a.oficina=e.id WHERE a.id=$vac_off";
...
$m_data['fecha']=$f_replace;
$m_data['fecha_cambio']=$fecha;

...
function sendMail($user, $m_data){
                                                                       ...
                                                                       <tbody>
                                                                          <tr>
                                                                             <td valign='top' style='padding-top: 9px;padding-right: 18px;padding-bottom: 9px;padding-left: 18px;mso-table-lspace: 0pt;mso-table-rspace: 0pt;-ms-text-size-adjust: 100%;-webkit-text-size-adjust: 100%;color: #606060;font-family: Helvetica;font-size: 15px;text-align: center;'>
                                                                                <p><span style='color: #5266a2; font-size: 24px; line-height: 130%;'>¡Hola $name!<br><br>Tu solicitud de Cambio/Baja ha sido Cancelada</span></p>
                                                                                <p style='line-height: 140%;'> El usuario <em><span style='color: #5266a2;'><strong>".$m_data['sol']."</strong></span>&nbsp;</em>ha cancelado la solicitud relacionada con el asesor:<br><br><span style='text-decoration: underline; color: #5266a2;'><strong>".$m_data['asesor']."<br></strong></span></p>
  ...
  mail("$user@pricetravel.com","Cancelacion de Solicitud (".$m_data['usuario'].")",$msg,$headers);
...
$query="SELECT usuario FROM mail_lists WHERE notif='cxlOK'";
if($result=Queries::query($query)){

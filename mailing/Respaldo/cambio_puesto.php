                                                                       ...
                                                                       <tbody>
                                                                          <tr>
                                                                             <td valign='top' style='padding-top: 9px;padding-right: 18px;padding-bottom: 9px;padding-left: 18px;mso-table-lspace: 0pt;mso-table-rspace: 0pt;-ms-text-size-adjust: 100%;-webkit-text-size-adjust: 100%;color: #606060;font-family: Helvetica;font-size: 15px;text-align: center;'>
                                                                                ...
                                                                                <p style='line-height: 140%;'> El usuario <em><span style='color: #5266a2;'><strong>".$m_data['sol']."</strong></span>&nbsp;</em>ha registrado el siguiente cambio:<br><span style='text-decoration: underline; color: #5266a2;'><strong>".$m_data['usuario']."<br></strong></span>Anterior: <span style='text-decoration: underline; color: #5266a2;'><strong>".$m_data['old_dep']." -&gt;&nbsp;".$m_data['old_puesto']."<br></strong></span>Nuevo: <span style='text-decoration: underline; color: #5266a2;'><strong>".$m_data['new_dep']." -&gt;&nbsp;".$m_data['new_puesto']."</strong>

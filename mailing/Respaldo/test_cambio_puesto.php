...
if( mail("$user@pricetravel.com","Nueva Vacante Solicitada ($user)",$msg,$headers)){
    echo 'Your mail has been sent successfully. mail("$user@pricetravel.com","Nueva Vacante Solicitada ($user)",$msg,$headers)';
} else{
    echo 'Unable to send email. Please try again. mail("$user@pricetravel.com","Nueva Vacante Solicitada ($user)",$msg,$headers)';
}

  
}

$m_data['old_dep']='DepTest';
$m_data['old_puesto']='PuestoTest';
$m_data['sol']='Solicitante';
$m_data['usuario']='usuariotest';
$m_data['new_dep']='NewDepTest';
$m_data['new_puesto']='NewPuestoTest';
$m_data['replace']=1;
$m_data['fecha']='2017-05-27';
$m_data['fecha_cambio']='2017-05-30';

sendMail('albert.sanchez',$m_data);

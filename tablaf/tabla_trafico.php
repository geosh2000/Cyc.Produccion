...
initSettings::printTitle('Tabla F - Trafico');
...
SELECT
	...
	Skill,
	CASE
		WHEN Skill=8 THEN 'Trafico-MT'
		WHEN Skill=9 THEN 'Trafico-MP'
	END as Grupo,
...
$query="SELECT
	Fecha, Grupo, Ofrecidas, Contestadas, Abandonadas, Abandonadas/Ofrecidas*100 as Abandon, Transferidas_min2, SLA/Ofrecidas*100 as SLA, TalkingTime/Contestadas as AHT, WaitTime/Contestadas as ASA,

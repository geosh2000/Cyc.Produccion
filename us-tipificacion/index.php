...
initSettings::start(true,'asesor_tipificacion_us');
initSettings::printTitle('Tipificación OB-MP');
...
$query="SELECT * FROM OBMP_opts WHERE activo=1 ORDER BY actividad, nivel, opcion";
...
<div class='formulario'>
    <div class='titulo'>
        <p style='padding-top: 13px; color: white;'>OB MP - Tipificación</p>

...
<button class='button button_red_w' id='testb'>Probar</button>
<div style='width: 40%; float: left;'><pre><?php print_r($current); ?></pre> </div>
<div style='width: 40%; float: left;'><pre><?php print_r($data); ?></pre> </div>

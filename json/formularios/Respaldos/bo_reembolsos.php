...
//Query
 $query="INSERT INTO bo_reembolsos
    ...
    if(mysql_errno()){
			    echo "status- ERROR -status msg- Error al cargar $sel_caso / $sel_loc / $sel_actividad / $sel_fecha / $sel_hora / $sel_minuto -msg";
                }else{
                    echo "status- OK -status msg- Registro Exitoso $sel_caso / $sel_loc -msg";}

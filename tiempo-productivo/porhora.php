...
$(function () {
    ...
    var optionsfc={
        title: {
            text: 'Avance Diario de Localizadores - Ventas',
            x: -20 //center
        },
        xAxis: {
            type: 'datetime',
        ...
        yAxis: [{
            ...
            title: {
                text: 'Cantidad de Localizadores'
            },
        },],
        tooltip: {
            valueSuffix: ''
    ...
    var optionsmonto={
        title: {
            text: 'Avance Diario de Venta - Ventas',
            x: -20 //center
        },
        xAxis: {
            type: 'datetime',
    ...
    $.getJSON('queryvporhora.php?type=montos&asesor=<?php echo $asesor; ?>&fechai=<?php echo $startmonth; ?>&fechaf=<?php echo $endmonth; ?>&mdt=<?php echo $metadt; ?>&mt=<?php echo $meta; ?>&skill=<?php echo $skill; ?>', function (activity) {
    ...
    $.getJSON('queryvporhora.php?type=locs&asesor=<?php echo $asesor; ?>&fechai=<?php echo $startmonth; ?>&fechaf=<?php echo $endmonth; ?>&skill=<?php echo $skill; ?>', function (activity) {
        $.each(activity.datasets, function (i, dataset) {

...
$(function () {
    ...
    $.getJSON('query.php?&dep=<?php echo $dep; ?>&type=montos&asesor=<?php echo $asesor; ?>&fechai=<?php echo $startmonth; ?>&fechaf=<?php echo $endmonth; ?>&mdt=<?php echo $metadt; ?>&mt=<?php echo $meta; ?>', function (activity) {
    	dataget=activity;
    ...
    $.getJSON('query.php?type=fc&asesor=<?php echo $asesor; ?>&fechai=<?php echo $startmonth; ?>&dep=<?php echo $dep; ?>&fechaf=<?php echo $endmonth; ?>', function (activity) {
        $.each(activity.datasets, function (i, dataset) {

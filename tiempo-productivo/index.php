...
$(function(){
  ...
  function drawChartOK() {
    ...
    function drawChart(){
      var jsonData = $.ajax({
          url: "../json/getData_ses_pausesv2.php?usuario=<?php echo $user; ?>",
          dataType: "json",
...
<div style='width: 200px; margin: auto;'><button id='ventatodos' class='button button_red_w'>Tabla Posiciones</button></div>
<?php

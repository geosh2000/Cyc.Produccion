...
$(function () {
    ...
    $.getJSON('query.php?dep=35&type=montos&asesor=<?php echo $asesor; ?>&fechai=<?php echo $startmonth; ?>&fechaf=<?php echo $endmonth; ?>&mdt=<?php echo $metadt; ?>&mt=<?php echo $meta; ?>', function (activity) {
    ...
    $.getJSON('query.php?type=fc&asesor=<?php echo $asesor; ?>&fechai=<?php echo $startmonth; ?>&fechaf=<?php echo $endmonth; ?>', function (activity) {
        $.each(activity.datasets, function (i, dataset) {

var status;
function sendRequest(asesor, semana, year, newVal){
        $.ajax({
          url: '/json/editableTable_query.php',
          type: 'POST',
          data: {queryIns: "INSERT INTO horarios_position_select VALUES ("+asesor+", "+semana+", "+year+", "+newVal+")", queryUpd: "Update horarios_position_select SET posicion="+newVal+" WHERE asesor="+asesor+" AND semana="+semana+" AND year="+year},
          dataType: 'json',
    ...
    $('#tableedit').tablesorter({
        ...
        widgetOptions: {
           ...
           uitheme: 'jui',
            ...
            editable_columns       : [3],       // or "0-2" (v2.14.2); point to the columns to make editable (zero-based index)
      ...
      var $this = $(this),
        ...
        if(validation==true){
        	sendRequest(asesor, semana, year ,newContent);
        }

...
foreach($data as $key1 => $row){
	...
	if($q_var!=""){
		$query="SELECT * FROM $db WHERE Fecha='".$data[$key1][8]."' AND Venta LIKE '".$data[$key1][5]."' AND Hora LIKE '".$data[$key1][9]."' AND Localizador='".$data[$key1][2]."'";
		echo "$query<br><br>";

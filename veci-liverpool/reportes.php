	...
	LEFT JOIN
		(
			SELECT
				...
				COUNT(IF(Desconexion='Transferida' AND Duracion_Real<'00:01:00' AND Canal LIKE '%veci%',ac_id,NULL)) as TransferidasMinVECI,
				...
				COUNT(IF(Desconexion='Transferida' AND Duracion_Real<'00:01:00' AND Canal LIKE '%liverpool%',ac_id,NULL)) as TransferidasMinLiverpool,

...
$init_Credential='asesor_tipificacion_ventas'; //Permisos para formulario
$init_title='Formulario - MSI Banamex';   //Titulo Formulario
$init_table='formulario_ventas_MSIBanamex'; //Tabla de opciones
$init_query='query_msi.php';     //Archivo para subir resultados
$init_saveTo='ventas_msiBanamex';     //Tabla para guardar resultados
 ...
 $(function(){
     ...
     $('#fecha_recepcion').periodpicker({
        ...
        onTodayButtonClick: function () {
            ...
            $('#fecha_recepcion').val('<?php echo date('Y-m-d'); ?>');
            $('#fecha_recepcion').periodpicker('change');
            return false;
        }
     });
      ...
      $.ajax({
        ...
        success: function(array){
          ...
          if(data['status']==1){
            ...
            $('.entrada').val('');
            $('#fecha_recepcion').periodpicker('clear');  
          }else{
...
<div style='width: 600px; background: #a6ddef; color: #717171; margin: auto; font-size: 20px; text-align: center; padding-top: 1px; padding-bottom: 1px;'>
  <p style='font-size: 25px'><?php echo $init_title; ?></p><p>Registros del dia: <span id='regs'></span> || Ultimo Registro: <span id='last'></span></p>
</div> 

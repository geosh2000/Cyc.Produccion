...
//Query	
	$query="SELECT "
				."Fecha, CONCAT(IF(HOUR(Hora)<10,'0',''),HOUR(Hora),':',IF(MINUTE(Hora)<30,'00','30')) as HoraGroup, Answered, COUNT(ac_id) as Llamadas "
				."FROM t_Answered_Calls a "
				."LEFT JOIN Cola_Skill b ON a.Cola=b.Cola "
				."WHERE Fecha BETWEEN '$inicio' AND '$fin' AND Skill=$dep $q_dow "

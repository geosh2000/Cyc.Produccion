...
initSettings::printTitle('Detalle de Afectaciones BackOffice - Llamadas');
	...
	function printTable(){
		...
		$('#result-table').tablesorter({
		    ...
		    widgetOptions: {
		    	//Builders
		    	build_type   : 'json',
      			build_source : { url: 'detalle_afect.php?tipo=2&from='+$('#from').val()+'&to='+$('#to').val(), dataType: 'json' },
                ...
                output_saveFileName  : 'Detalle_Afectaciones_Llamadas<?php echo $from."a".$to;?>.csv',

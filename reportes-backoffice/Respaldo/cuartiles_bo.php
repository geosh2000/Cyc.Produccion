...
$tbody.="<option value='38' $selected[38]>Confirming</option><option value='37' $selected[37]>Mailing</option><option value='40' $selected[40]>Mejora Continua</option><option value='39' $selected[39]>Reembolsos</option>";
$tbody.="</select></td>";

				...
				function asesores(skill,name){
					...
					while(i<total){
						...
						switch(parseInt(tmpstatus[1])){
							//Avail
							case 0:
								agent_block="<div class='asesor avail' status='"+tmpstatus[1]+"'><div class='name'>"+tmpagent[1]+"</div><div class='availtime' seg='"+tmpavailseg[1]+"'>"+tmpavail[1]+"</div><div class='callqueue'>Tiempo Disponible</div></div>";
	                    	...
	                    	//OnPause OnCall
							case 3:
								agent_block="<div class='asesor onpausecall' status='"+tmpstatus[1]+"'><div class='name'>"+tmpagent[1]+"</div><div class='calldetails' seg='"+tmpcallseg[1]+"'>"+tmpcaller[1]+" || "+tmpcalldur[1]+"</div><div class='callqueue'>"+tmpqueue[1]+"</div></div>";
	                    		$('#res_asesores').append(agent_block);
	                    		break;
	                    	//Outcall
							case 4:
	                    	...
	                    	//notLogged
							case 5:
								agent_block="<div class='asesor notLogged' status='"+tmpstatus[1]+"'><div class='name'>"+tmpagent[1]+"</div><div class='availtime' seg='"+tmpavailseg[1]+"'>"+tmpavail[1]+"</div><div class='callqueue'>Tiempo Disponible</div></div>";
	                    		$('#res_asesores').append(agent_block);
	                    		break;
	                    	default:

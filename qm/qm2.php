...
<body style='background: white; zoom: .75;'>
<br>
    ...
    function printRow($depart){
        ...
        echo "<div class='container$bgstylec' ><p id='$depart-Online' style='margin: 0;'><img src='/images/online.png' height='60' width='60'> ".$info[' all selected ']['agentes']."</p><br><p style='font-size: 40px; color: black; margin-top: 0'>Online</p></div>";
        echo "<div class='container$bgstylec'  id='pause' $bgp><p id='$depart-Aux' style='margin: 0;'><img src='/images/paused.png' height='60' width='60'> ".$info[' all selected ']['pausa']."</p><br><p style='font-size: 40px; color: black; margin-top: 0'>Aux</p></div>";
        echo "<div class='container$bgstylec' ><p id='$depart-Avail' style='margin: 0;'><img src='/images/avail.png' height='60' width='60'> ".$info[' all selected ']['disponibles']."</p><br><p style='font-size: 40px; color: black; margin-top: 0'>Avail</p></div>";
        echo "<div class='container$bgstylec'  id='waiting'><p id='$depart-In' style='margin: 0;'><img src='/images/inbound.png' height='60' width='60'> ".$info[' all selected ']['in']."</p><br><p style='font-size: 40px; color: black; margin-top: 0'>In-Call</p></div>";
        echo "<div class='container$bgstylec'  id='waiting' $bg><p id='$depart-Wait' style='margin: 0;'><img src='/images/waiting.png' height='60' width='60'> ".$info[' all selected ']['espera']."</p><br><p style='font-size: 40px; color: black; margin-top: 0'>Waiting</p></div>";
        echo "<div class='container$bgstylec'  style='width: 320; text-align: left;' id='aht' $bg><p id='$depart-AHT' style='margin: 0; font-size:70px; text-align:center; margin-top:13px;'>".number_format($info[' all selected ']['AHT'],0)."</p><br><p style='text-align: center; font-size: 40px; color: black; margin-top: 0'><img src='/images/aht.png' height='60' width='60'>AHT</p></div>";
        echo "</div>
            <br>
            </div>";
    }

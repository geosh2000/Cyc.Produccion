...
<br>
    ...
    function printRow($depart){
        ...
        echo "<div class='container$bgstylec' ><p id='$depart-Calls' style='margin: 0;'><img src='/images/inbound.png' height='60' width='60'> ".$info[' all selected ']['Calls']."</p><br><p style='font-size: 40px; color: black; margin-top: 0; text-align:center'>T. Calls</p></div>";
        echo "<div class='container$bgstylec'  id='pause' $bgp><p id='$depart-Answered' style='margin: 0;'><img src='/images/avail.png' height='60' width='60'> ".$info[' all selected ']['Answered']."</p><br><p style='font-size: 40px; color: black; margin-top: 0; text-align:center'>Answered</p></div>";
        echo "<div class='container$bgstylec' ><p id='$depart-Unanswered' style='margin: 0;'><img src='/images/cross.png' height='60' width='60'> ".$info[' all selected ']['Unanswered']."</p><br><p style='font-size: 40px; color: black; margin-top: 0; text-align:center'>Unanswered</p></div>";
        echo "<div class='container$bgstylec sla'  id='waiting'><p id='$depart-Abandon' style='margin: 0;'><img src='/images/abandon.png' height='60' width='60'> ".$info[' all selected ']['Abandon']."%</p><br><p style='font-size: 40px; color: black; margin-top: 0; text-align:center'>Abandon</p></div>";
        echo "<div class='container$bgstylec sla'  id='waiting' $bg><p id='$depart-SLA' style='margin: 0;'><img src='/images/sla.png' height='60' width='60'> ".$info[' all selected ']['SLA']."%</p><br><p style='font-size: 40px; color: black; margin-top: 0; text-align:center'>SLA</p></div>";

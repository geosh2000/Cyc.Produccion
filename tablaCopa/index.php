...
<table style='width:600px; margin:auto' class='t2'><form action="<?php  $_SERVER['PHP_SELF']; ?>" method="post">
    ...
    <tr class='title'>
         ...
         <th colspan="100">Resultados Copa Vacations</th>
...
function tipificacion(){
    ...
    for($i=0;$i<$num;$i++){
        ...
        $soporte=mysql_result($result,$i,'tipo_soporte');
        $localidad=mysql_result($result,$i,'localidad_agencia');
...
<div id="accordion">
  ...
  <h3>Metas</h3>
    ...
    <table style="margin: auto; width: 80%;text-align:center" class='t2'>
        <tr class='title'>
            <th>M�trica</th><th>AHT</th><th>SLA</th><th>ASA</th><th>Abandon</th><th>Adherencia</th><th>Ocupaci�n</th><th>Rotaci�n</th><th>FC (conversi�n)</th>
        </tr>
        <tr class='pair'>
            <td class='subtitle'>F�rmula</td><td>Tiempo promedio de transacci�n sumando (Talk time + ACW + Hold)</td><td>Total de llamadas Contestadas &#60= Umbral /Llamadas Ofrecidas</td>
            <td>Umbral en el cual se est�n contestando las llamadas</td><td>Llamadas abandonadas / Llamadas ofrecidas</td><td>Cantidad de FTEs Reales/cantidad FTEs programados</td>
            <td>(Tiempo de conversaci�n inbound + tiempos conversi�n outbound) /horas de conexi�n</td><td>(Rotaci�n personal voluntario + involuntario) / total personal al final de mes</td>
